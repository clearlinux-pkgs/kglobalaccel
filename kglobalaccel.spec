...
Source0  : https://download.kde.org/stable/frameworks/6.3/kglobalaccel-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kglobalaccel-6.3.0.tar.xz.sig
...
%setup -q -n kglobalaccel-6.3.0
cd %{_builddir}/kglobalaccel-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717774440
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6GlobalAccel.so.6.3.0
/usr/lib64/libKF6GlobalAccel.so.6
/usr/lib64/libKF6GlobalAccel.so.6.3.0
