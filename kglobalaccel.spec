...
Source0  : https://download.kde.org/stable/frameworks/5.68/kglobalaccel-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/kglobalaccel-5.68.0.tar.xz.sig
...
%prep
%setup -q -n kglobalaccel-5.68.0
cd %{_builddir}/kglobalaccel-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584313711
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kglobalaccel-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kglobalaccel/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5GlobalAccel.so.5.68.0
/usr/lib64/libKF5GlobalAccelPrivate.so.5
/usr/lib64/libKF5GlobalAccelPrivate.so.5.68.0
