...
Version  : 6.0.0
Release  : 77
URL      : https://download.kde.org/stable/frameworks/6.0/kglobalaccel-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/kglobalaccel-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/kglobalaccel-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kglobalaccel-6.0.0
cd %{_builddir}/kglobalaccel-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709221961
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6GlobalAccel.so.6.0.0
/usr/lib64/libKF6GlobalAccel.so.6
/usr/lib64/libKF6GlobalAccel.so.6.0.0
