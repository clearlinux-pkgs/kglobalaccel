...
Version  : 6.2.0
Release  : 82
URL      : https://download.kde.org/stable/frameworks/6.2/kglobalaccel-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/kglobalaccel-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kglobalaccel-6.2.0.tar.xz.sig
...
%setup -q -n kglobalaccel-6.2.0
cd %{_builddir}/kglobalaccel-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715613304
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6GlobalAccel.so.6.2.0
/usr/lib64/libKF6GlobalAccel.so.6
/usr/lib64/libKF6GlobalAccel.so.6.2.0
